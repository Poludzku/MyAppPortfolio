...
import static com.poludzku.spotifystreamer.dashboard.DashboardFragment.FAVOURITES;

public class ChangeFavouriteUseCase {

    SharedPreferences sharedPreferences;

    @Inject
    public ChangeFavouriteUseCase(SharedPreferences sharedPreferences) {
